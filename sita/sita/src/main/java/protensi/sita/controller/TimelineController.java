...
public class TimelineController {
    ...
    public String readTimelinePage(Model model){
        ...
        LocalDate dateStartUgb = timeline.getStartUGB();
        LocalDate dateEndUgb = timeline.getEndUGB();
        ...
        if(dateStartUgb != null && dateEndUgb != null){
            pel_ugb = Integer.toString(dateStartUgb.getDayOfMonth()) + "-"
                        + Integer.toString(dateEndUgb.getDayOfMonth()) + " "  
                        + StringUtils.capitalize(dateStartUgb.getMonth().toString().toLowerCase()) + " "
                        + Integer.toString(dateStartUgb.getYear());
        }
        if(datePengUgb != null){
        ...
        model.addAttribute("pel_ugb", pel_ugb);
    ...
    public String updateTimelineSubmitPage(@ModelAttribute TimelineModel tl){
        ...
        existingTl.setStartUGB(tl.getStartUGB());
        existingTl.setEndUGB(tl.getEndUGB());
